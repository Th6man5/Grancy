        ...
        <div class="flex text-black mr-3">
            <?php if (isset($_SESSION['user_name'])) : ?>
                <div class="flex items-center group">
                    ...
                    <a href="<?= $_SESSION['user'] ? '#' : ($_SESSION['admin'] ? "http://localhost/grancy/src/admin/admindashboard.php" : '#') ?>" class="text-xl opacity-70 group-hover:opacity-100 transition-all" style="font-family: League Spartan, sans-serif;"><?php echo $_SESSION['user_name']; ?></a>
                </div>
