            ...
            <?php if (isset($_SESSION['user_name'])) : ?>
                <div class="flex items-center group">
                    <svg width="40" height="40" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg" class="mr-2 opacity-70 group-hover:opacity-100 transition-all">
                        <path d="M41.6666 43.75V39.5833C41.6666 37.3732 40.7886 35.2536 39.2258 33.6908C37.663 32.128 35.5434 31.25 33.3333 31.25H16.6666C14.4564 31.25 12.3368 32.128 10.774 33.6908C9.21123 35.2536 8.33325 37.3732 8.33325 39.5833V43.75" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    ...
                    <a href="<?= $_SESSION['user'] ? 'userprofile.php' : ($_SESSION['admin'] ? "http://localhost/grancy/src/admin/admindashboard.php" : '#') ?>" class="text-xl opacity-70 group-hover:opacity-100 transition-all" style="font-family: League Spartan, sans-serif;"><?php echo $_SESSION['user_name']; ?></a>
                </div>
                ...
                <div class="flex items-center">
                    <a href="http://localhost/grancy/src/database/logout.php" class="text-xl opacity-70 hover:opacity-100 transition-all" style="font-family: League Spartan, sans-serif;">
                        Logout
                    </a>
                </div>
            <?php else : ?>
