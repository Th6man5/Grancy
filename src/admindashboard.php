        ...
        <div class="p-4 sm:ml-64">
            <div class="p-4 mt-14">
                <div class="grid grid-cols-4 gap-4 mb-4">
                    <div class="grid grid-rows-3 h-36 rounded bg-gray-50 dark:bg-gray-800 bg-blues2">
                ...
                <div class="flex items-center justify-center h-48 mb-4 rounded bg-gray-50 dark:bg-gray-800 bg-blues">
                    <p class="text-2xl text-gray-400 dark:text-gray-500">
                    </p>
                </div>
                <div class="grid grid-cols-2 gap-4 mb-4">
                    <div class="flex items-center justify-center rounded bg-gray-50 h-28 dark:bg-gray-800 bg-blues2">
                        <p class="text-2xl text-gray-400 dark:text-gray-500">
                        </p>
                    </div>
                    <div class="flex items-center justify-center rounded bg-gray-50 h-28 dark:bg-gray-800 bg-blues2">
                    ...
                    <div class="flex items-center justify-center rounded bg-gray-50 h-28 dark:bg-gray-800 bg-blues">
                        <p class="text-2xl text-gray-400 dark:text-gray-500">
                        </p>
                    </div>
                    <div class="flex items-center justify-center rounded bg-gray-50 h-28 dark:bg-gray-800 bg-blues">
                ...
                <div class="flex items-center justify-center h-48 mb-4 rounded bg-gray-50 dark:bg-gray-800 bg-blues2">
                    <p class="text-2xl text-gray-400 dark:text-gray-500">
                    </p>
                </div>
